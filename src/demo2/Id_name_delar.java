 ...
 * @author Happy
 */
public class Id_name_delar extends javax.swing.JFrame {

    /**
     * Creates new form Id_name_delar
     */
    public Id_name_delar() 
    {
    ...
    // MySQL database connection
                 ...
                 try
                 {
                     String sql1="select * from delar WHERE Estimate!=Received or Remark='pending'";
                         ...
                         while(rs.next())
         {
            ...
            // String s9=rs.getString("Status");
             ...
             String s11=rs.getString("Count");

            model.addRow(new Object[]{d,s3,s5,s7,s11});
             //cnt++;
          }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Id_name_delar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
