...
//import javax.swing.JOptionPaneimport javax.swing.JTable;
;
 ...
 * @author Happy
 */
public class Id_name extends javax.swing.JFrame {

    /**
     * Creates new form Id_name
     */
    public Id_name() {
    ...
    // MySQL database connection
                 ...
                 try
                 {
                     String sql1="select * from customer WHERE Estimate!=Received OR Remark='pending' ";
                         ...
                         while(rs.next())
         {
            ...
            model.addRow(new Object[]{d,s3,s5,s7});
             //cnt++;
          }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Id_name.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
